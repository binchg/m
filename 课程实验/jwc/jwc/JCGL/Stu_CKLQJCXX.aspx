...
<tr height=5%><td valign="top" align="center" height="26">
     <table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
      <tr> 
     <td width="95%" align="left"><input type="checkbox" value='0' name="chk" onClick=if(this.checked==true){this.value='0';}else{this.value='1';} checked>含未领取&nbsp;</td>
     <td width="5%" align="right" ><input type="submit" name="btn_search" value="检索" class=button></td>
     </tr>

...
<html>
<head>
<title>分院(系)/部/处室按时间查看监考安排(考场→监考人员)</title>
...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>分院(系)/部/处室按时间查看监考安排(考场→监考人员)</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="a_jksjqd_rpt.aspx" target="main" >              
...
<iframe name=main src="a_jksjqd_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>
</body>
</html>
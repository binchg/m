...
private void Page_Load(object sender,System.EventArgs e)
{
   ...
   //saveform
	...
	try{
		Response.Output.Write((new BLL_kssw(this))._sys_kc_Query_rpt(actionFunction,pSub.USER_ID,vGX,vKCDM,vKSPC,vKSDM,vJSDM,xn,xq,ksdm,pc,kcdm,jsdm,
...
function ChkValue(theForm)
{
 ...
 if (Form.SKRS.value != Form.SKRS.value) 
    { alert('需用数字录入实考人数！');
      Form.SKRS.focus();
      return false }
 if (Form.SJNO1JZ.value != Form.SJNO1JZ.value) 
    { alert('需用数字录入考试1/2时间交卷人数！');
      Form.SJNO1JZ.focus();
      return false }
 if (Form.SJNO15JZ.value != Form.SJNO15JZ.value) 

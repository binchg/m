...
{
	string vXNXQ="",vKS="",vCK="",vCDDW="",vKC="",vTitle="试卷已领取信息";
	...
	try{
		Response.Output.Write((new BLL_kssw(this))._sjylq_rpt(vXNXQ,vKS,vCK,vCDDW,vKC,ThePer,TheAlign,TheHeadStr).ToString());
	}catch(Exception ex){}

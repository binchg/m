...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>统计学生缓考情况</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="h_hkkc_rpt.aspx" target="main" >              
	...
	<tr><td valign="bottom" align="left" colspan=2><%=ind_sp.SetValue("xnxqkslc","")%></td></tr>
	   ...
	   <td valign="bottom" align="center" name="diskc" id="diskc" style="height=25px;width=400px;display:none" nowrap>
	    <%=ind_sp.SetValue("yxzy",pSub.USER_OPTYX)%></td>
          </tr>
          	<tr><td valign="bottom" align="left"><input type="radio" value="2" id="ckjs" name="ckjs" onclick="Selcx(this)" >分院(系)部/按年级/专业<input type="radio" value="1" id="ckjs" name="ckjs" onclick="Selcx(this)"  checked >分承担单位按课程</td>
...
<iframe name=main src="h_hkkc_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>
</body>
</html>

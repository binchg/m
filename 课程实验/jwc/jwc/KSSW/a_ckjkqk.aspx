...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>查看监考情况</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="a_ckjkqk_rpt.aspx" target="main" >              
	...
	<tr><td valign="bottom" align="left" colspan=2><%=ind_sp.SetValue("xnxqkslc","")%></td></tr>
	   ...
	   <td valign="bottom"  name="diskc" id="diskc" style="height=25px;width=400px;display:none" nowrap>院(系)/部&nbsp;<select name="sel_yx" style="width:140px">
	    <%=ind_sp.SetValue("yx",pSub.USER_OPTYX)%></select></td>
          </tr>
...
<iframe name=main src="a_ckjkqk_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>
</body>
</html>
...
if (vScoreAll!="")
{
	...
	vHTML=vHTML+"<a  href=javascript:void(0) onclick=MM_openBrWindow(\"KPJG.aspx?xn="+vXN+"&xq="+vXQ+"&xh="+USER_ID+"&kcdm="+vKCDM+"&jsdm="+vJSDM+"&lb="+vLB+"&kclb="+vKCLB+"&zj_flag="+vZJ_FLAG+"&pjlc="+vPJLC+"\",\"winKPT\",\"width=450,height=490,scrollbars=yes\"); title=查看评分>查看</a>";

...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>按综合评价结果查看教师排名</b></td></tr>
		<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
		</td></tr>
      </table>   
</td></tr>
<tr><td valign="top" align="center" width="100%">
	<form name="form1" method="post" action="b_jspjjgbm_rpt.aspx" target="main" >              
	<table width="660" border=0 cellpadding=0 cellspacing=1 align="center" height="26">
		<tr><td colspan=3>
			...
			<td width=60>院(系)/部</td><td><select name=sel_yx style='width:150'><%=SelObj.SetValue("yx",USER_OPTYX)%></select></td>
			</tr></table>
		</td>
...
<iframe name=main src="b_jspjjgbm_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr>
</table>
</body>
</html>

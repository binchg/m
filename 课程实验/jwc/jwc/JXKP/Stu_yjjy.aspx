<%@ Page language="c#" Codebehind="Stu_yjjy.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.JXKP.Stu_yjjy" %>
...
<HTML>
	...
	<body bgcolor="#ffffff" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<form name="form1" action="stu_yjjy_rpt.aspx" method="post" target="main">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td valign="top" align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td valign="bottom" align="center"><b>提交问卷调查表</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td valign="top" align="center" height="100%">
						<iframe name="main" src="stu_yjjy_rpt.aspx" width="99%" height="98%" frameborder="0">
						</iframe>
					</td>
				</tr>
			</table>

...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>教学工作量</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="Tea_jxgzl_Rpt.aspx" target="frmRpt">
	<tr><td valign="top" align="center" height="5%" width="100%">
	<table width="660" border=0  align="center">
	<tr> 
		<!--td valign="bottom" align="left" nowrap>学年学期&nbsp;<SELECT id=sel_xnxq name=sel_xnxq ><%=SelObj.SetValue("xnxq","")%></SELECT></td-->	
		<td><%=SelObj.SetValue("XNXQJSLC","")%></td>
...
<iframe name=frmRpt src="Tea_jxgzl_Rpt.aspx" width=99% height=90% frameborder=0></iframe>
</td></tr>
</table>
</body>
</HTML>
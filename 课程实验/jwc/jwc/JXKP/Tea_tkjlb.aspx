...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>听课记录信息</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="Tea_tkjlb_rpt.aspx" target="frmRpt">
	<tr><td valign="top" align="center" height="5%" width="100%">
	<table width="660" border=0  align="center">
		<tr> 
		<td><%=SelObj.SetValue("XNXQPJLC","2")%></td>
		<td valign="bottom" align="right"  nowrap><input name="Submit" type="submit" value="检索" class="button" ID="Submit1"></td>
     	</tr>
     	<tr><td colspan=2>
     		<table border=0 cellpadding=0 cellspacing=0>
     		<tr><td width=55>评价主体</td><td><select name=sel_pjzt style="width:100"><%=SelObj.SetValue("PJZT","20")%></select></td></tr>
     		</table>
     	</td></tr>
	</table>
</td></tr>
...
<iframe name=frmRpt src="Tea_tkjlb_rpt.aspx" width=99% height=99% frameborder=0></iframe>
</td></tr>
</table>
</body>
</HTML>
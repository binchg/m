...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>分课程/环节→教师按评价主体成员查看评价结果</b></td></tr>
		<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
		</td></tr>
      </table>   
</td></tr>
<tr><td valign="top" align="center" width="100%">
	<form name="form1" method="post" action="b_kcjspjjs_rpt.aspx" target="main" >              
	<table width="660" border=0 cellpadding=0 cellspacing=1 align="center" height="26">
		...
		<tr><td>
			...
			<td width=165>
				<table border=0 cellpadding=0 cellspacing=0>
     			<tr><td width=55>评价主体</td><td width=105><select name=sel_pjzt style="width:100"><%=SelObj.SetValue("PJZT","")%></select></td></tr>
     			</table>
     		</td>
		...
		<tr><td>
			...
			<td align="right"><input type="submit" name="Submit" value="检索" class=but20 onclick="Mssage()"></td>
			</tr></table>
		<td></tr></table>    
</td></tr>
</form>
...
<iframe name=main src="b_kcjspjjs_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr>
</table>
</body>
</html>
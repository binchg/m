...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>分院(系)/部按教师查看教学工作量</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="c_jskcjxgzl_rpt.aspx" target="frmRpt">
	...
	<tr><td>
		...
		<td align="right"><input name="Submit" type="submit" value="检索" class="button" ID="Submit1"></td>
		</tr></table>
	</td></tr>
	</table>
</td></tr>
...
<iframe name=frmRpt src="c_jskcjxgzl_rpt.aspx" width=99% height=90% frameborder=0></iframe>
</td></tr>
</table>
</body>
</HTML>
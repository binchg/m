...
function popWinJWDT(theID){
	if ((theID.href)!="")
	{var pop,w=660,h=550; 
	var theURL='../_data/news/index.aspx?href='+theID.href; //window.navigate(theURL);
	pop=window.open(theURL,"winDWL","width="+w+",height="+h+",resizable=yes,menubar=yes,toolbar=yes,location=no,scrollbars=yes,status=no")

<%@ Page language="c#" Codebehind="R_ZXBY_BZZBYXSMC.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.XSXJ.R_ZXBY_BZZBYXSMC" %>
<%@ Import NameSpace="BLL.XSXJ"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>本转专毕业学生名册</title>
	...
	<body  onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
		...
		<form name="form1" action="R_ZXBY_BZZBYXSMC_Rpt.aspx" target="frmRpt" method="post" onsubmit='return ChkValue()'>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
				<tr>
					<td vAlign="top" align="center" height="26">
						<table WIDTH="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td vAlign="bottom" align="center"><b>本转专毕业学生名册</b></td>
							</tr>
							<tr>
				...
				<tr>
					...
					<iframe name=frm  style='display:none;'></iframe>
						<iframe name="frmRpt" src="R_ZXBY_BZZBYXSMC_Rpt.aspx" width="100%" height="98%" frameborder="0"></iframe>

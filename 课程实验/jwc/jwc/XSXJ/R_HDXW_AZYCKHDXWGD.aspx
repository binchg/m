<%@ Page language="c#" Codebehind="R_HDXW_AZYCKHDXWGD.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.XSXJ.R_HDXW_AZYCKHDXWGD" %>
...
<HTML>
	...
	<body onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
		...
		<form name="form1" action="R_HDXW_AZYCKHDXWGD_Rpt.aspx" target="frmRpt" method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
				...
				<tr>
					<td valign="bottom" align="center" height="100%">
						<iframe name="frmRpt" src="R_HDXW_AZYCKHDXWGD_Rpt.aspx" width="100%" height="98%" frameborder="0">
						</iframe>
					</td>
				</tr>
			</table>

...
<%@ Page language="c#" Codebehind="R_XJDA_ZXXSMC_print.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.XSXJ.R_XJDA_ZXXSMC_print" %>
<HTML>
	<HEAD>
		<title>在校学生名册</title>
	...
	<body oncontextmenu="window.event.returnValue=false" onselectstart="window.event.returnValue=false"
		...
		<form name="form1" onsubmit="return ChkVal()" action="R_XJDA_ZXXSMC_print_Rpt.aspx" method="post"
			target="frmRpt">
			<FONT face="宋体">-</FONT>
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<tr>
					<td vAlign="bottom" align="center" height="100%"><IFRAME name="frmRpt" src="R_XJDA_ZXXSMC_print_Rpt.aspx" frameBorder="1" width="100%" height="98%">

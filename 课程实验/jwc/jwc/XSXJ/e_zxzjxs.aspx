	...
	<body  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
			<tr>
				<td vAlign="top" align="center" colSpan="3">
					<table height="26" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
						<tr>
							<td vAlign="bottom" align="center"><b>在校/在籍学生情况</b></td>
						</tr>
						<tr>
			...
			<tr>
				<td id="objCx" vAlign="top" align="center" height="4%">
					<form name="form1" method="post" action="e_zxzjxs_rpt.aspx" target="main">
			...
			<tr>
				<td width="100%" colspan="5"><table width="100%" cellpadding="0" border="0" cellspacing="0">
						<tr>
							<td width="60">学年学期</td>
							<td width=110><select name="sel_pycc">
									<%=html_xnxq%>
								</select></td>
								<td align=left width=210><input type=radio name=radCx checked value="">在校/在籍
	    <input type=radio name=radCx value="1">在校
	    <input type=radio name=radCx value="2">在籍</td><td width=190><input name="flag" value="sec" type=hidden></td>
		...
		<tr>
			<td id="ifr" vAlign="top" align="center" height="100%">
				<iframe name="main" src="e_zxzjxs_rpt.aspx?flag=firstload" frameBorder="0" width="99%" height="98%">
				</iframe>
			</td>
		</tr>
		</table>

<%@ Page language="c#" Codebehind="R_FXBY_FXBYXSMC.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.XSXJ.R_FXBY_FXBYXSMC" %>
<%@ Import NameSpace="BLL.XSXJ"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>辅修毕业学生名册</title>
	...
	<body onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
		...
		<form name="form1" action="R_FXBY_FXBYXSMC_Rpt.aspx" target="frmRpt" method="post" onsubmit='return ChkValue()'>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
				...
				<tr>
					...
					<iframe name=frm  style='display:none;'></iframe>
						<iframe name="frmRpt" src="R_FXBY_FXBYXSMC_Rpt.aspx" width="100%" height="98%" frameborder="0"></iframe>

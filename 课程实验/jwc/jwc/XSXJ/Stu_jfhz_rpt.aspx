...
//USER_ID="200500000008";

Response.Output.Write(pSub.HtmlHear());
xsxj.ArrayDefineXSSFHZ();
R=xsxj.GetTableXSSFHZ(USER_ID);
Response.Output.Write(xsxj.DrawRptHead(USER_ID,R));
if(R>0)
{
	Response.Output.Write(xsxj.DrawMainXSSFHZ());
}

		...
		<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
			<tr>
				<td vAlign="top" align="center" colSpan="3">
					<table height="20" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
						<tr>
							<td vAlign="bottom" align="center"><b>获得双学位学生名册</b></td>
						</tr>
						<tr>
			...
			<tr>
				<td id="objCx" vAlign="top" align="center" height="4%">
					<form name="form1" method="post" action="h_XSSXWMX_rpt.ASPX" target="main">
			...
			<tr>
				<td id="ifr" vAlign="top" align="center" height="100%">
					<iframe name="main" src="h_XSSXWMX_rpt.ASPx?flag=firstload" frameBorder="0" width="99%"
						height="98%"></iframe>
				</td>
			</tr>
		</table>

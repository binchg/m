...
<HTML>
	...
	<body bgcolor="#ffffff" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
			<tr>
				<td valign="top" align="center">
					<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
						<tr>
							<td valign="bottom" align="center"><b>学籍异动明细</b></td>
						</tr>
						<tr>
			...
			<form action="h_BYXSQK_rpt.aspx" method="post" name="doublecombo" target="main">
				<tr>
					<td valign="top" align="center" height="5%">
						<table width="640" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td>年级<select name="sel_nj"><%=html_xn%></select></td>
								<td width="29%">院(系)/部<select name="Sel_YX" style="WIDTH:129px"><%=html_yx%></select><input name="flag" type="hidden" value="sec"></td>
								<td width=270></td>
			...
			<tr>
				<td valign="top" align="center" height="100%" width="660">
					<iframe name="main" src="h_BYXSQK_rpt.aspx?flag=firstload" width="99%" height="98%" frameborder="0">
					</iframe>
				</td>
			</tr>
		</table>

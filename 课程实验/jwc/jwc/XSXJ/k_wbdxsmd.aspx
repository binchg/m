	...
	<body  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
			...
			<tr>
				<td id="objCx" vAlign="top" align="center" height="4%">
					<form name="form1" method="post" action="k_wbdxsmd_rpt.aspx" target="main">
			...
			<tr>
				<td width="100%" colspan="5"><table width="100%" cellpadding="0" border="0" cellspacing="0">
						<tr>
							...
							<td align="left" width="210"><input type="checkbox" value="1" name="chkCx" checked onclick="disrad(this)">全部
								<input type="radio" value="" name="radCx" id="radCx1" checked disabled>未报到 <input type="radio" value="0" name="radCx" id="radCx2" disabled>不报到<input name="flag" value="sec" type="hidden"></td>
		...
		<tr>
			<td id="ifr" vAlign="top" align="center" height="100%">
				<iframe name="main" src="k_wbdxsmd_rpt.aspx?flag=firstload" frameBorder="0" width="99%"
					height="98%"></iframe>
			</td>
		</tr>
		</TBODY></TABLE>

<%@ Page language="c#" Codebehind="R_YJBY_YJBYXSTJ.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.XSXJ.R_YJBY_YJBYXSTJ" %>
<%@ Import NameSpace="BLL.XSXJ"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>预计毕业学生统计</title>
	...
	<body onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
		...
		<form name="form1" action="R_YJBY_YJBYXSTJ_Rpt.aspx" target="frmRpt" method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
				<tr>
					<td vAlign="top" align="center" height="26">
						<table WIDTH="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td vAlign="bottom" align="center"><b>预计毕业学生统计</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td valign="bottom" align="center" height="100%">
						<iframe name="frmRpt" src="R_YJBY_YJBYXSTJ_Rpt.aspx" width="100%" height="98%" frameborder="0">
						</iframe>
					</td>
				</tr>
			</table>

<%@ Page language="c#" Codebehind="R_XJDA_FXXSTJ.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.XSXJ.R_XJDA_FXXSTJ" %>
...
<HTML>
	...
	<body onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
		...
		<form name="form1" action="R_XJDA_FXXSTJ_Rpt.aspx" target="frmRpt" method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
				<tr>
					<td vAlign="top" align="center" height="26">
						<table WIDTH="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td vAlign="bottom" align="center"><b>辅修学生统计</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td height="56">
						<table height="100%" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
							<tr>
								<td width="34%" height="28px">学年学期&nbsp;<select name="Sel_XNXQ" style="WIDTH:165px" onchange=ShowListValue(this,'XNXQ_ZFXNJ')>
								    <option value="Nothing">--------请选择--------</option><%=(new XSXJ_Rpt().GetXNXQInfo())%></select></td>
								<td align="left" height="28px" width="60%" id="Area_FXNJ" style="display:"><%=(new XSXJ_Rpt().SetValue("FXNJ_ZY",""))%></td>
								<td align="left" height="28px" width="60%" id="Area_ZXNJ" style="display:none" ><%=(new XSXJ_Rpt().SetValue("ZXNJ_ZY",""))%></td>
								<td align="right" height="28px" width="6%" nowrap><input class="button" type="submit" name="submit" value="检索"></td>
							</tr>
							<tr>
								<td colspan="4" height="28px" align=left>
				...
				<tr>
					<td valign="bottom" align="center" height="100%">
						...
						<iframe name="frmRpt" src="R_XJDA_FXXSTJ_Rpt.aspx" width="100%" height="98%" frameborder="0"></iframe>
					</td>
				</tr>
			</table>
		</form>

...
<HTML>
	...
	<body onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
		...
		<form name="form1" action="R_XJDA_ZXXSMC_Rpt.aspx" target="frmRpt" method="post" onsubmit='return ChkVal()'>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
				...
				<tr>
					<td height="56">
						<table height="100%" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
							...
							<tr>
								<td width="58%" align=left height="28px">学年学期&nbsp;<select name="Sel_XNXQ" style="WIDTH:165px" onchange=ShowListValue(this,"XNXQ_NJ")><%=(new XSXJ_Rpt().GetXNXQInfo())%></select>
								                                         培养层次&nbsp;<select name="Sel_PYCC" style="WIDTH:100px"><%=(new XSXJ_Rpt().GetPYCCInfo())%></select>
								</td>
								<td width="36%" align=left height="28px">
									&nbsp;学号/姓名&nbsp;<input type="text" name="txtXS" maxlength=20 size=15>
								</td>
								<td align="right" width="6%" nowrap  height="28px">
								<input class="button" type="submit" name="submit" value="检索"></td>
							</tr>
				...
				<tr>
					<td valign="bottom" align="center" height="100%">
						<iframe name="frmRpt" src="R_XJDA_ZXXSMC_Rpt.aspx" width="100%" height="98%" frameborder="0"></iframe>

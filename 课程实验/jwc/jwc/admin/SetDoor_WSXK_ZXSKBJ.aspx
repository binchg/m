...
<form name=form1 action=SetDoor_WSXK_ZXSKBJ_rpt.aspx method=post target=frmRpt onsubmit='return ChkValue()'>
...
<iframe name=frmRpt src="SetDoor_WSXK_ZXSKBJ_rpt.aspx" width=99% height=99% frameborder=0></iframe>

...
private void Page_Load(object sender,System.EventArgs e)
{
	...
	try
	{
		Response.Output.Write((new purviewManage(this)).S_CDDWGroup2_Left(vL,ThePer,TheAlign,TheHeadStr));
	}
	catch(Exception ex)
	{
...
function SubmitUserID(theID,thegrp)
{
	...
	SourceURL="S_CDDWGroup2_Source.aspx?grp="+theID+"&g="+thegrp;
	ResultURL="S_CDDWGroup2_Result.aspx?grp="+theID+"&g="+thegrp;

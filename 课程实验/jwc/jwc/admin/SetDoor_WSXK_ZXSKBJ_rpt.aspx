...
if(Request.ServerVariables["REQUEST_METHOD"]=="POST")
{
	...
	Response.Output.Write("<form name='form1' method='post' action='SetDoor_WSXK_ZXSKBJ_rpt.aspx?submit=ok'> ");
	try{
		Response.Output.Write(pSub.DrawMain_ZXSKBJ(ThePer,TheAlign,vCDDW,vKC,sRS1,sRS2,vKCLB));
	}catch(Exception){}

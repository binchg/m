...
<html>
  <head>
		...
		try{
			...
			if(obj.checked){
				if(s=="roleRad"){
					...
					//document.all.nameStr.innerHTML='学号';
	...
	function chkValue(){
		try{
			...
			if(s!=""){
				window.Form1.action="S_BrowseStuPurview_Rpt.aspx";
  ...
  <body  topmargin='0' leftmargin='0' oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false" onsource="window.event.returnValue=false">
		<form name="Form1" action="S_BrowseStuPurview_Rpt.aspx" target="frmRpt" method="post">
			<table border="0" width="99%" height="100%" cellspacing="0" cellpadding="0" align="center">
						...
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr >
								...
								<td align="left" width="70%" id="searchTextStr" style="display:none;">
									学号&nbsp;<input type="text" name="txtSearch" onchange="onchangeTxt(this)" maxlength="30" style="width:102px;display:none;"><span id="opSelTxt"><select name="sel_txt" style="width:165px;"><option value=""></option></select></span>
								</td>
				...
				<tr>
					...
					<iframe id="frmRpt" name="frmRpt" src="S_BrowseStuPurview_Rpt.aspx" frameborder=0 style="width:100%;height:99%"></iframe>
					</td>
				</tr>
			</table>
			</form>

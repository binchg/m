...
private void Page_Load(object sender,System.EventArgs e)
{
	...
	string[] TheHeadStr=new string[]{"序号","院(系)/部"};
	
	Response.Output.Write((new ind_subPublic()).page_Head_HTML("","styles_Rpt"));
	try
	{
		Response.Output.Write((new purviewManage(this)).S_YXGroup1_Left(ThePer,TheAlign,TheHeadStr));
	}
	catch(Exception ex)
	{
...
SourceURL="S_YXGroup1_Source.aspx?grp="+theID+"&g="+thegrp;
ResultURL="S_YXGroup1_Result.aspx?grp="+theID+"&g="+thegrp;

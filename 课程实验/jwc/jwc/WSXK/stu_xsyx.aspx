<%@ Page language="c#" Codebehind="stu_xsyx.aspx.cs" AutoEventWireup="false" Inherits="JWNET.WSXK.stu_xsyx" %>
...
<HTML>
	...
	leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<form name="form1" action="stu_xsyx_rpt.aspx" method="post" target="frmRpt">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td vAlign="top" align="center">
						<table height="26" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
							<tr>
								<td vAlign="bottom" align="center"><b>预选</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td vAlign="bottom" align="center" height="90%">
						<iframe name="frmRpt" src="stu_xsyx_rpt.aspx" frameBorder="0" width="100%" height="98%">
						</iframe>
					</td>
				</tr>
			</table>

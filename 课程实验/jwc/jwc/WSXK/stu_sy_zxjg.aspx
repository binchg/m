<%@ Page language="c#" Codebehind="stu_sy_zxjg.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.WSXK.stu_sy_zxjg" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align=center>
			...
			<tr>
				<td valign="bottom" align="center" height="100%">
					<iframe name="frmRpt" src="stu_sy_zxjg_rpt.aspx" width="100%" height="98%" frameborder="0">
					</iframe>
				</td>
			</tr>
		</table>

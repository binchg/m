<%@ Page language="c#" Codebehind="R_SKBJXSMC.aspx.cs" AutoEventWireup="false" Inherits="JWNET.WSXK.R_SKBJXSMC" %>
<%@ Import NameSpace="BLL.WSXK"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>上课班级学生名册</title>
		...
		<script language="javascript">
			...
			function ChkValue()
			{
				...
				try{
					vCDDW=document.all.Sel_CDDW.value;
					vKC=document.all.Sel_KC.value;
					if((vCDDW=="")||(vCDDW=="Nothing"))
					{
						alert('请选择承担单位!');return false;
					}
					else if((vKC=="")||(vKC=="Nothing"))
					{
...
<body oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false leftmargin="0" topmargin="0">
	<form name="form1" method="POST" action="R_SKBJXSMC_rpt.aspx" target="main" onsubmit="return ChkValue()" >
	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" >
		<tr><td valign="top" align="center">
			<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
				<tr><td valign="bottom" align="center"><b>上课班级学生名册</b></td></tr>
		...
		<tr><td valign="bottom" align="center" height="5%"><br></td></tr> 
		<tr><td valign="top" align="center" height="100%">
			<iframe name=main src="R_SKBJXSMC_rpt.aspx" width=99% height=99% frameborder=0></iframe>

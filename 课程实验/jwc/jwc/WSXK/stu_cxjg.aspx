<%@ Page language="c#" Codebehind="stu_cxjg.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.WSXK.stu_cxjg" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
			<tr>
				<td vAlign="top" align="center" height="26">
					<table WIDTH="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
						<tr>
							<td vAlign="bottom" align="center"><b>重修选结果</b></td>
						</tr>
						<tr>
					...
					<table height="100%" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
						<tr>
							...
							<td align="right" width="70" nowrap>&nbsp;
								...
								<input class="button" type="button" name="submit" value="退选" onclick="return ChkVal()"
									disabled></td>
							<%}%>
						</tr>
					</table>
			...
			<tr>
				<td valign="bottom" align="center" height="100%">
					<iframe name="frmRpt" src="stu_cxjg_rpt.aspx" width="100%" height="98%" frameborder="0">
					</iframe>
				</td>
			</tr>
		</table>

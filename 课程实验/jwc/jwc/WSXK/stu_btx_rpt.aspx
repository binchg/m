<%@ Page language="c#" Codebehind="stu_btx_rpt.aspx.cs" AutoEventWireup="false" Inherits="JWNET.WSXK.stu_btx_rpt" %>
...
<HTML>
	<HEAD>
		...
		<script language="JavaScript" type="text/JavaScript">
			...
			function openWinDialog(theID,N)
			{
				...
				var url="stu_xszx_chooseskbj.aspx?lx=BX&id="+theID.value+"&skbjval="+skbjval;
				//alert(url);
			...
			function ChkValue(theObj)
			{
				...
				if(s1=="提交正选"){
					...
					strurl="stu_btx_rpt.aspx?func=1";
	...
	<body  onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
	 leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<form action='stu_btx_rpt.aspx?func=1' method="post" name="FormAdd">

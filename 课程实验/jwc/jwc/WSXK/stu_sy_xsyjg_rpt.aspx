<%@ Page language="c#" Codebehind="stu_sy_xsyjg_rpt.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.WSXK.stu_sy_xsyjg_rpt" %>
...
<HTML>
	...
	leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<form action="stu_sy_xsyjg_rpt.aspx?func=1" method="post" name="form1">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0" align="center">
				<tr>
					<td align="left" width="100%" height="99%" valign="top">

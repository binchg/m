<%@ Page language="c#" Codebehind="R_QXZXXSMD.aspx.cs" AutoEventWireup="false" Inherits="JWNET.WSXK.R_QXZXXSMD" %>
<%@ Import NameSpace="BLL.WSXK"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>被取消正选学生名单</title>
...
<body oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false leftmargin="0" topmargin="0">
	<form name="form1" method="POST" action="R_QXZXXSMD_rpt.aspx" target="main" onsubmit="return ChkValue()" >
	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" >
		<tr><td valign="top" align="center">
			<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
				<tr><td valign="bottom" align="center"><b>被取消正选学生名单</b></td></tr>
		...
		<tr><td valign="top" align="center" height="100%">
			<iframe name=main src="R_QXZXXSMD_rpt.aspx" width=99% height=98% frameborder=0></iframe>

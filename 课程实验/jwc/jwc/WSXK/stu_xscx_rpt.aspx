<%@ Page language="c#" Codebehind="stu_xscx_rpt.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.WSXK.stu_xscx_rpt" %>
...
<HTML>
	<HEAD>
		...
		<script language="JavaScript" type="text/JavaScript">
			...
			function openWinDialog(theID,N)
			{
				...
				var url="stu_xszx_chooseskbj.aspx?lx=CX&id="+theID.value+"&skbjval="+skbjval;
			...
			function ChkValue(theObj)
			{
				...
				if(s1=="提交重修选"){
					...
					strurl="stu_xscx_rpt.aspx?func=1";
	...
	leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<form action='stu_xscx_rpt.aspx?func=1' method="post" name="FormAdd">

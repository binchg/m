<%@ Page language="c#" Codebehind="stu_sy_xszx.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.WSXK.stu_sy_xszx" %>
...
<HTML>
	...
	<body  onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
	 leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<form name="form1" action="stu_sy_xszx_rpt.aspx" method="post" target="frmRpt">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<td height="28">
						<table height="100%" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
							<tr>
								...
								<td align="left" width="135" nowrap><%=xnxqstr%><br></td>
								<td align="left" width="60" nowrap>时间区段：</td>
								<td align="left"><%=timestr%><br></td>
								<td align="right" width="100" nowrap >&nbsp;
								<%if(seacher_flag=="show"){%>
									<input class="button" type="submit" value="检索" name="Submit">
									<input class="button" type="button" name="submit" value="提交" onclick="frmRpt.document.all.Submit.onclick()">
								<%}%>
								</td>
							</tr>
						</table>
				...
				<tr>
					<td vAlign="bottom" align="center" height="90%">
						<iframe name="frmRpt" src="stu_sy_xszx_rpt.aspx" frameBorder="0" width="100%" height="98%"></iframe>
					</td>
				</tr>
			</table>
		</form>

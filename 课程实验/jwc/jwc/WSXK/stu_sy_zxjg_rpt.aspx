<%@ Page language="c#" Codebehind="stu_sy_zxjg_rpt.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.WSXK.stu_sy_zxjg_rpt" %>
...
<HTML>
	...
	<body onselectstart="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		onsource="window.event.returnValue=false" leftMargin="0" topMargin="0" marginheight="0"
		marginwidth="0">
		<form action="stu_sy_zxjg_rpt.aspx?func=1" method="post" name="form1">

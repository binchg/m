<%@ Page language="c#" Codebehind="stu_sy_txjg_rpt.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.WSXK.stu_sy_txjg_rpt" %>
...
<HTML>
	...
	<body onselectstart="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		marginwidth="0">
		<form action="stu_sy_txjg_rpt.aspx?func=1" method="post" name="form1">

...
<%@ Page language="c#" Codebehind="R_ZXXSMD.aspx.cs" AutoEventWireup="false" Inherits="JWNET.WSXK.R_ZXXSMD" %>
...
<HTML>
	...
	<body oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		<form name="form1" method="post" action="R_ZXXSMD_rpt.aspx" target="main" onsubmit="return ChkValue()">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td valign="top" align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td valign="bottom" align="center"><b>正选学生名单</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td valign="top" align="center" height="100%">
						<iframe name="main" src="R_ZXXSMD_rpt.aspx" width="99%" height="98%" frameborder="0">

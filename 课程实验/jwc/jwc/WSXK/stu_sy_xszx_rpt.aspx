<%@ Page language="c#" Codebehind="stu_sy_xszx_rpt.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.WSXK.stu_sy_xszx_rpt" %>
...
<HTML>
		...
		<script language="JavaScript" type="text/JavaScript">
			...
			function ChkValue(theObj)
			{
				...
				if(s1=="提交正选"){
					...
					strurl="stu_sy_xszx_rpt.aspx?func=1";
	...
	<body onselectstart="window.event.returnValue=false" oncontextmenu="window.event.returnValue=false"
		...
		<form action='stu_sy_xszx_rpt.aspx?func=1' method="post" name="FormAdd">

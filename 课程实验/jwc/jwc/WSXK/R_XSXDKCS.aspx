<%@ Page language="c#" Codebehind="R_XSXDKCS.aspx.cs" AutoEventWireup="false" Inherits="JWNET.WSXK.R_XSXDKCS" %>
<%@ Import NameSpace="BLL.WSXK"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>学生修读课程/环节</title>
		...
		<script language="javascript">
			...
			function ChkValue()
			{
				...
				try{
					...
					else if((vXZBJ=="")||(vXZBJ=="Nothing"))
					{
						alert('请选择行政班级!');return false;
					}
					else{return true;}
				}
				catch(e){}
	...
	<body oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		<form name="form1" method="post" action="R_XSXDKCS_rpt.aspx" target="main" onsubmit="return ChkValue()">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td valign="top" align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td valign="bottom" align="center"><b>学生修读课程/环节</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td valign="top" align="center" height="100%">
						<iframe name="main" src="R_XSXDKCS_rpt.aspx" width="99%" height="98%" frameborder="0">

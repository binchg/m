...
{
	string vXNXQ="",vBJ="",vJD="",vKC="",vTime="",vTitle="实习学生";
	...
	try{ vTime=Request.QueryString["time"].ToString().Trim();}catch(Exception){};
	
	try{
		Response.Output.Write((new ind_subPrivate_JXSJ())._sxzcxs_rpt(vXNXQ,vKC,vBJ,vJD,vTime,ThePer,TheAlign,TheHeadStr).ToString());
	}catch(Exception ex){

...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>分承担单位按课程设计查看题目</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="c_akcsjcktm_rpt.aspx" target="main" >              
...
<iframe name=main src="c_akcsjcktm_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 

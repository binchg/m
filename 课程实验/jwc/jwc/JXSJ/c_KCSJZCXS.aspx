...
{
	string vXNXQ="",vKC="",vBJ="",vTime="",vTitle="课程设计学生";
	...
	try{
		Response.Output.Write((new ind_subPrivate_JXSJ())._KCSJZCXS_Rpt(vXNXQ,vKC,vBJ,vTime,ThePer,TheAlign,TheHeadStr).ToString());
	}catch(Exception ex){

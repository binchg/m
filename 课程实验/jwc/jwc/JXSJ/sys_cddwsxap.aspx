...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>承担单位实习安排</b></td></tr>
	...
	<table width="660" border="0" cellspacing="0" cellpadding="0" height="26">
		<tr><td colspan=2>
			...
			<tr>
				...
				<td align="left" id=discddw>&nbsp;承担单位 <select name=sel_cddw style='width:150;HEIGHT: 20px'><%=(new ind_subPrivate_JXSJ()).SetValue("cddw",USER_OPTDW)%></select></td>
				<td>
				<div align=right><input type="submit" name="btn_search" value="检索" class=button></div>
				</td>
			</tr>
			</table>
			</td>

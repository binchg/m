...
parent.document.all.tops.src="sys_dbzjfz_top.aspx?zy="+zy+"&dw="+dw+"&nj="+parent.document.all.nj.value+"&xz="+arr[2];
parent.document.all.downs.src="sys_dbzjfz_down.aspx?zy="+zy+"&dw="+dw+"&nj="+parent.document.all.nj.value+"&xz="+arr[2];
}
</script>
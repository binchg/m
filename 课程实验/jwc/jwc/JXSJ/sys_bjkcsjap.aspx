...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>班级课程设计安排</b></td></tr>
...
<form name="form1" method="post" action="c_bjkcsjap_rpt.aspx" target="main" >              
	...
	<table width="660" border=0 cellspacing="0" cellpadding="0" height="26">
		...
		<td align="left" id=disnj width=90>年级 <select name=sel_nj><%=(new ind_subPublic()).PutValue("xn","","sj_fbxqsjjxap")%></select></td>
		<td align="left" id=disyx width=215>院(系)/部 <select name=sel_yx style='width:150'><%=(new ind_subPublic()).PutValue("yx",USER_OPTYX)%></select></td>
		<%}catch(Exception ex){

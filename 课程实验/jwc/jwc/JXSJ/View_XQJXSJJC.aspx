	...
	<head>
		...
		private void Page_Load(object sender,System.EventArgs e){
			...
			try{
				...
				opCDDW.Text=pri.SetValue("cddw",myPage.CUR_UserInfo.USER_OptYX);
				opYX.Text=SelObj.SetValue("yx",myPage.CUR_UserInfo.USER_OptYX).ToString();
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  height="52">
											<tr align="left" valign="middle">
												<td width="35%">
													...
													<input type="radio" id="hjtobj" name="RADBJ" onclick="chkRAD(this)" value="2">分环节按班级</td>
											...
											<tr align="right" valign="middle">
												<td align="left" width="16%" colspan="2">学年学期&nbsp;<select name="selXNXQ" style="WIDTH:168px"><asp:Literal ID="opXNXQ" Runat="server" Text=""/></select></td>
												<td width="30%" colspan="2"><input type="submit" name="search" value="检索" class="but20"></td>
											</tr>
										</table>
									</td>
								</tr>

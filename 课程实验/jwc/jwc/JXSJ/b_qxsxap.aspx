...
function SelRpt(){
if (document.all.radCx0.checked){form1.action='b_qxsxapjs_rpt.aspx'}
if (document.all.radCx1.checked){form1.action='b_qxsxap_rpt.aspx'}
if (document.all.radCx2.checked){form1.action='b_qxsxapjd_rpt.aspx'}
}
</script>
</head>
...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>全校实习安排</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="b_qxsxapjs_rpt.asp" target="main" >              
	...
	<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
		...
		<select name=sel_xnxq style='width:165'><%=(new ind_subPrivate_JXSJ()).SetValue("sjxnxq","")%></select>
		  <input type=radio name=radCx id=radCx0 value="0" checked >按指导教师
		  <input type=radio name=radCx id=radCx1 value="1" >按行政班级
		  <input type=radio name=radCx id=radCx2 value="2" >按实习基地</td>
...
<iframe name=main src="b_qxsxapjs_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>
</td></tr>
</table>

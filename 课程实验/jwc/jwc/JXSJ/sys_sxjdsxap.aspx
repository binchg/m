...
<HTML>
	...
	<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
			<tr>
				<td valign="top" align="center">
					<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
						<tr>
							<td valign="bottom" align="center"><b>实习基地实习安排</b></td>
						</tr>
						<tr>
			...
			<form name="form1" method="post" action="b_sxjdap_rpt.aspx" target="main">
				<tr>
								...
								<td colspan="2">
									<table width="660" border="0" cellspacing="0" cellpadding="0" height="26">
										<tr>
											...
											<td align="left" id="disjd">&nbsp;实习基地 <input type="text" name="txt_jd" value='' size="20" maxlength="50"></td>
			...
			<tr>
				<td valign="top" align="center" height="99%">
					<iframe name="main" src="b_sxjdap_rpt.aspx" width="99%" height="98%" frameborder="0">
					</iframe>
				</td>
			</tr>
		</table>

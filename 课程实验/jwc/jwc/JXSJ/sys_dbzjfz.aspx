	   ...
	   for(j=1;j<=sn;j++){
		...
		else if(window.document.all.hiddenZY.value==''||window.document.all.hiddenXZ.value=='')
		{
		  alert('须选定专业！');
		    ...
		    zc=window.document.all.zuci.value;
		    if(zc==""||zc.indexOf('.')>0||isNaN(zc))
		    {
		       alert("组次录入不正确，请重新录入！");
		    }
		    else
		    {
				...
				strurl='sys_dbzjfz_down.aspx?theval='+radval+'&zy='+zy+'&xz='+xz+'&nj='+nj+'&dw='+dw+'&types=1'+'&zc='+zc;//alert(zc);			
				form1.action=strurl;
				form1.method='post';
				form1.target='downs';
				form1.submit();
				strurl='sys_dbzjfz_top.aspx?theval='+radval+'&zy='+zy+'&xz='+xz+'&nj='+nj+'&dw='+dw;//alert(strurl);			
				form1.action=strurl;
				form1.method='post';
				form1.target='tops';
				form1.submit();
   ...
   var zy='',xz='',nj='',dw='';  
	   ...
	   for(j=1;j<=sn;j++){
		...
		if(radval==''){
		    ...
		    zy=window.document.all.hiddenZY.value;xz=window.document.all.hiddenXZ.value;
		    nj=window.document.all.nj.value;dw=window.document.all.yx.value;
		    strurl='sys_dbzjfz_down.aspx?theval='+radval+'&zy='+zy+'&xz='+xz+'&nj='+nj+'&dw='+dw+'&types=2';//alert(zc);			
				form1.action=strurl;
				form1.method='post';
				form1.target='downs';
				form1.submit();
...
function loadDW()
{
   ...
   url="sys_dbzjfz_left.aspx?nj="+nj+"&dw="+dw;
...
function postValue()
{
  ...
  nj=window.document.all.nj.value;
   ...
   url="sys_dbzjfz_top.aspx?nj="+nj+"&dw="+dw;
 ...
 // window.document.all.form1.submit();
		...
		private void Page_Load(object sender,System.EventArgs e){
				...
				try{
					...
					vXNXQ=mydata.getXNXQofJXSJCtrl("sj_yxdodbzjfz");
					if(vXNXQ.Length==0)
						Response.Redirect ("../_help/Sorry.aspx?str=STOP_DOOR");
					else
						DoorOnOff("SJ_YX_TBZJFZ");
				}catch(Exception ex){
			...
			<tr>
				<td vAlign="top" align="center" colSpan="3">
					<table height="26" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
						<tr>
							<td vAlign="bottom" align="center"><b>答辩专家分组</b></td>
						</tr>
						<tr>
				...
				<td id="objCx" vAlign="top" align="center" height="4%">
					<fieldset><legend></legend>
						<table id="tblJbcx" height="100%" cellSpacing="0" cellPadding="0" width="660" align="center"
							...
							<tr>
								<td width="53" >毕业年届</td>
								<td width="60" align="left" id="thenj"><select name="nj" style="WIDTH:55px"><%=(new ind_subPublic()).PutValue("xn","","sj_yxdodbzjfz")%></select>
								</td>
					...
					<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" height="100%">
						<tr>
								...
								<fieldset style="WIDTH:100%;HEIGHT:98%"><legend>专业</legend>
									<table border="0" cellpadding="0" cellspacing="0" align="left" width="100%" height="99%">
										<tr>
											...
											<iframe name="leftFrame" src="sys_dbzjfz_left.aspx" width="98%" height="99%" frameborder="0"></iframe>
											</td>
										</tr>
							...
							<td height="45%" valign="middle" width="100%">
								<fieldset style="WIDTH:100%;HEIGHT:77%"><legend><asp:Literal id="pgfs" runat="server" Text="未分组答辩专家"></asp:Literal></legend>
									<table border="0" cellpadding="0" cellspacing="0" align="left" width="100%" height="99%">
									     <tr>
										...
										<tr>
											<td valign="top" align="" height="100%" colspan=2>
												<iframe name="tops" src="sys_dbzjfz_top.aspx" width="350" height="99%" frameborder="1"></iframe>
											</td>											
										</tr>
									</table>
								</fieldset>
							...
							<table border="0" cellpadding="0" cellspacing="0" align="left" width="100%" height="99%">
									     <tr>
						    <td width=20% >&nbsp;<input name=selectA type=checkbox value=""  onclick=SelAll(this)>全选</td><td width=25% >组次&nbsp;<input name=zuci value='' type=text style="width:50px"></td>     
							<td>
							...
							<tr>
							<td height="45%" valign="middle" width="100%">
								<fieldset style="WIDTH:100%;HEIGHT:77%"><legend><asp:Literal id="Literal1" runat="server" Text=""></asp:Literal></legend>
									<table border="0" cellpadding="0" cellspacing="0" align="left" width="100%" height="99%">
										<tr>
											<td valign="top" align="center" height="100%">
												<iframe name="downs" src="sys_dbzjfz_down.aspx" width="350" height="99%" frameborder="1"></iframe>
											</td>											
										</tr>
									</table>
								</fieldset>

...
if(theval!="")
 {
    try{
       ...
       for(int i=0;i<Counts;i++)
       {
        ...
        {  
            if(types=="1")
			   dat.insertZJFZ(njs.ToString(),zy.ToString(),theValue[i].ToString(),zc);
			 else if(types=="2")
			   dat.delZJFZ(njs.ToString(),zy.ToString(),theValue[i].ToString());
		}catch{}
       }
    }catch{}
 }
	Response.Output.Write(jxzy.Draw_bdzjfz_down(njs.ToString(),zy));
	//Response.Write(zc);
%>

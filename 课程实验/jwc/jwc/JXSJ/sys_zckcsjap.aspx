...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>周次课程设计安排</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="c_zckcsjap_rpt.aspx" target="main" >              
	...
	<table width="660" border=0 cellspacing="0" cellpadding="0" height="26">
		...
		<td align="left" id=disnj  width=90>年级 <select name=sel_nj><%=(new ind_subPublic()).PutValue("xn","")%></select></td>
		<td align="left" id=diszc >周次 <input type=text name=txt_zc value='' size=2 maxlength=2></td>
		<%}catch(Exception ex){
...
<iframe name=main src="c_zckcsjap_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 

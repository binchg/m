...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>未安排毕业论文答辩</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="d_wapbydb_rpt.aspx" target="main" >              
	<tr><td valign="top" align="center" height="5%" >
	<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
		<tr><td align="left" height="26" colspan=2>
		学年学期<%try{%>
		<select name=sel_xnxq style='width:165'><%=(new ind_subPrivate_JXSJ()).SetValue("sjxnxq","")%></select>
		</td></tr>
		<tr>
		<td width=17%>毕业年届
		<select name=sel_nj onchange='changezy()'><%=(new ind_subPublic()).PutValue("pub_xn","")%></select></td>
...
<iframe name=main src="d_wapbydb_rpt.aspx" width=100% height=98% frameborder=0></iframe>
</td></tr> 
</table>
</td></tr> 
</table>

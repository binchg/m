...
private void Page_Load(object sender,System.EventArgs e)
{
	...
	try{
		Response.Output.Write(pJ.Set_Byxf_Rpt_right(vYX,vNJ,fx_flag,ThePer,TheAlign,TheHeadStr).ToString());
	}catch(Exception ex){
...
function LeftReset(){
try{
PivID=parent.frameleft.document.all.PSTemp.ValueID
PivColor=parent.frameleft.document.all.PSTemp.PivColor
PivFontColor=parent.frameleft.document.all.PSTemp.PivFontColor
}catch(e){return false}
try{
eval("parent.frameleft."+PivID+".style.backgroundColor='"+PivColor+"';");
eval("parent.frameleft."+PivID+".style.color='"+PivFontColor+"';");
}catch(e){return false}
}
</script> 
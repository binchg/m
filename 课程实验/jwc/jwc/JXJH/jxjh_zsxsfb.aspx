...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>专业环节周数与必修课学时分布</b></td></tr>
...
<form name="form1" method="post" action="jxjh_zsxsfb_rpt.aspx" target="main" onSubmit="return ChkValue(this)">              
      <tr><td valign="top" align="center" height="5%" >
        <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
          <tr>
		<td align=left>年级<select name=sel_nj><%=(new ind_subPublic()).PutValue("xn","","")%></select></td>

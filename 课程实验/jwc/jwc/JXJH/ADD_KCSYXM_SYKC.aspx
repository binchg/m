<%@ Page language="c#" Codebehind="ADD_KCSYXM_SYKC.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.JXJH.ADD_KCSYXM_SYKC" %>
<HTML>
	<HEAD>
		<title></title>
		...
		<script language=javascript>
			function trdblclick(Object,dm)
			{
				try{
					...
					parent.document.all.kcdm.value=dm;
					theURL='ADD_KCSYXM_rpt.aspx?kcdm='+dm;
					parent.frmRpt.location.href=theURL;
				}catch(e){}
			}
		</script>
	</HEAD>

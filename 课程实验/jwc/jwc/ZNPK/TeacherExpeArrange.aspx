<%@ Page language="c#" Codebehind="TeacherExpeArrange.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.TeacherExpeArrange" %>
<%@ Import NameSpace="BLL.ZNPK"%>
<HTML>
	<HEAD>
		<title>指导教师实验安排表</title>
			...
			function ChkValue()
			{
				...
				try{
					...
					if((vJS=="")||(vJS=="Nothing")){
						...
						form.method='post';
						form.action='TeacherExpeArrange_rpt.aspx';
						form.target='frmRpt';
						form.submit();
						return true;
					}
	...
	<body oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		marginheight="0">
		<form name="form" method="post" action="TeacherExpeArrange_rpt.aspx" onsubmit="return ChkValue()">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td valign="top" align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td valign="bottom" align="center"><b>指导教师实验安排表</b></td>
							</tr>
							<tr>
					...
					<td height="28">
						<table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td width="52%"><%=(new Base().SetValue("JS"))%></td>
				...
				<tr>
					<td valign="top" align="center" height="100%">
						...
						</iframe><iframe name="frmRpt" src="TeacherExpeArrange_rpt.aspx" width="99%" height="99%" frameborder="0">
						</iframe>
					</td>
				</tr>
			</table>

<%@ Page language="c#" Codebehind="StudentSel.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.StudentSel" %>
...
<html>
  <head>
			...
			function ChkValue()
			{
				...
				try{
					...
					if((vXS=="")||(vXS=="Nothing")){alert('需选定学生！');return false;}
						...
						form.method='post';
						form.action='StudentSel_rpt.aspx';
						form.target='frmRpt';
						form.submit();
						return true;
					}
	...
	leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<form name="form" method="post" action="StudentSel_rpt.aspx" ID="Form">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
			<tr>
				<td valign="top" align="center">
					<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
						<tr>
							<td valign="bottom" align="center"><b>学生课表</b></td>
						</tr>
						<tr>
			...
			<tr>
				<td valign="top" align="center" height="97%">
					...
					<iframe name="frmRpt" src="StudentSel_rpt.aspx" width="99%" height="98%" frameborder="0"></iframe>
				</td>
			</tr>
		</table>
		</form>

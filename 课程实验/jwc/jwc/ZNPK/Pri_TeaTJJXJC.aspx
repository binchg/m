<%@ Page language="c#" Codebehind="Pri_TeaTJJXJC.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.Pri_TeaTJJXJC" %>
...
<HTML>
	...
	<body oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		<form name="form1" method="post" action="Pri_TeaTJJXJC_rpt.aspx" target=frmRpt>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
			...
			<tr>
				<td valign="top" align="center" height="100%">
					<iframe name="frmRpt" src="Pri_TeaTJJXJC_rpt.aspx" width="99%" height="99%" frameborder="0"></iframe>
				</td>
			</tr>
		</table>
		</form>

<%@ Page language="c#" Codebehind="Pri_TeacSel_Fzgc.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.Pri_TeacSel_Fzgc" %>
...
<HTML>
	...
	<body onselectstart="window.event.returnValue=false" oncontextmenu="window.event.returnValue=false"
		...
		<asp:Panel ID="pageRpt" Runat="server"></asp:Panel><FONT face="宋体"></FONT>
	</body>
</HTML>

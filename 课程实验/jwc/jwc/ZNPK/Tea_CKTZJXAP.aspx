<%@ Page language="c#" Codebehind="Tea_CKTZJXAP.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.Tea_CKTZJXAP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>查看调整教学安排</title>
	...
	<body onselectstart=window.event.returnValue=false oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false 
		...
		<form name="form1" method="post" action="Tea_CKTZJXAP.aspx" >
		<TABLE WIDTH="574" BORDER="0" align="center" CELLPADDING="0" CELLSPACING="0" bordercolorlight="#75a7ae"
			...
			<tr>
				<td valign="top" align="center">
					<table width="567" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
						<tr>
							<td valign="bottom" align="center"><b>查看调整教学安排</b></td>
						</tr>
						<tr>
			...
			<tr><td valign="top" align="center"><%=vHTML%></td></tr>
			
			<tr>
				<td align="right" width="100%" colspan="2"  style="height:28px">
					<input name="submit" type="submit" value="取消" class="button" >
					<input name="return" type="button" value="返回" class="button" onclick='window.close();'>&nbsp;</td>
			</tr>

<%@ Page language="c#" Codebehind="KBFB_LessonSel.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.KBFB_LessonSel" %>
...
<HTML>
			...
			function ChkValue()
			{
				...
				try{
					...
					if((vKCID=="")||(vKCID=="Nothing")){
						...
						form.method='post';
						form.action='KBFB_LessonSel_rpt.aspx';
						form.target='frmRpt';
						form.submit();
						return true;
					}
	...
	leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<form name="form" method="post" action="KBFB_LessonSel_rpt.aspx" onsubmit="return ChkValue()">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
			<tr>
				<td valign="top" align="center">
					<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
						<tr>
							<td valign="bottom" align="center"><b>课程课表</b></td>
						</tr>
						<tr>
			...
			<tr>
				<td height="28px">
					<table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							<td width="34%" align=left >学年学期&nbsp;<select name='Sel_XNXQ'  style='WIDTH:165px'><%=(new Base().SetValue("XNXQ"))%></select></td>
							<td width="52%" align=left><%=(new Base().SetValue("XNXQKC"))%></td>
			...
			<tr>
				<td valign="top" align="center" height="100%">
					...
					<iframe name="frmRpt" src="KBFB_LessonSel_rpt.aspx" width="99%" height="98%" frameborder="1">
					</iframe>
				</td>
			</tr></table>
			</form>

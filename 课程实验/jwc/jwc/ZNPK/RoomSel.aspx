<%@ Page language="c#" Codebehind="RoomSel.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.RoomSel" %>
...
<HTML>
	...
	<body oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false
	 leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<form name="form" method="post" action="RoomSel_rpt.aspx" onsubmit="return ChkValue()">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				...
				<td height="56px" >
					<table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<input name="Submit01" type="submit" value="检索" class="button" onclick="return ChkValue()"></td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				<td valign="top" align="center" height="97%">
					...
					<iframe name="frmRpt" src="RoomSel_rpt.aspx" width="99%" height="98%" frameborder="0">
					</iframe>
				</td>
			</tr></table>
			</form>

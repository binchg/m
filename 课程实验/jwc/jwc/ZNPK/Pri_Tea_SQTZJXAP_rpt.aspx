<%@ Page language="c#" Codebehind="Pri_Tea_SQTZJXAP_rpt.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.Pri_Tea_SQTZJXAP_rpt" %>
<HTML>
	<HEAD>
		<title></title>
		...
		function op(vURL,vXNXQ,vSKBJ)
		{
			var theURL;
			winName="winKPT";
			Tform='width=590,height=300,scrollbars=yes,menubar=no,resizable=no,location=no,status=no';
			theURL =vURL+'?xnxq='+vXNXQ+'&vSKBJ='+vSKBJ;

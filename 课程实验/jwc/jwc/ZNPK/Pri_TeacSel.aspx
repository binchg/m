<%@ Page language="c#" Codebehind="Pri_TeacSel.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.Pri_TeacSel" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
			...
			<tr>
				<td>
					<table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
						<form name="form" method="post" action="Pri_TeacSel_rpt.aspx" ID="Form" target="frmRpt">
								<tr>
									...
									<td width="47%" id="sel_area" style="visibility:hidden" >
										<input value="1" name="zc_flag" type=checkbox onclick=if(this.checked){document.all.zc_input.disabled=false;document.all.zc_input.focus();}else{document.all.zc_input.disabled=true;}>周次&nbsp;<input type=text style="width:80px" name="zc_input" disabled onblur=ChkZcVal(this) value="1-18">
										排序&nbsp;<select name="px" style="width:143px"><option value=0>按课程/环节</option><option value=1>按时间</option></select>
									</td>
								</tr>
								<tr>
			...
			<tr>
				<td valign="top" align="center" height="100%">
					...
					<iframe name="frmRpt" src="Pri_TeacSel_rpt.aspx" width="99%" height="98%" frameborder="0"></iframe>
				</td>
			</tr>
		</table>
	</body>

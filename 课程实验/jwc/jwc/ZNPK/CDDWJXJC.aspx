<%@ Page language="c#" Codebehind="CDDWJXJC.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.CDDWJXJC" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
			...
			<tr>
				<td height="22">
					<table width="660" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
						<form name="form1" method="post" action="CDDWJXJC_rpt.aspx" target="frmRpt" onSubmit='return FSearch()'>
								<tr>
									<td width="100%" ><%=(new Base().SetValue("XNXQKCCDDWJXJC","%"))%></td>
			...
			<tr>
				<td valign="top" align="center" height="100%">
					<iframe name="frmRpt" src="CDDWJXJC_rpt.aspx" width="100%" height="100%" frameborder="0">
					</iframe>
				</td>
			</tr>
			</table>

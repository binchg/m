<%@ Page language="c#" Codebehind="TeacherKBFB.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.TeacherKBFB" %>
  ...
  <head>
	...
	<body oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false
	 leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<form name="form" method="post" action="TeacherKBFB_rpt.aspx" onsubmit="return ChkValue()">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align=center>
				...
				<td height="52px">
					<table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="52%"><%=(new Base().SetValue("JS","220"))%></td>
			...
			<tr>
				<td valign="top" align="center" height="100%">
					...
					<iframe name="frmRpt" src="TeacherKBFB_rpt.aspx" width="100%" height="99%" frameborder="1"></iframe>
				</td>
			</tr>
		</table>
		</form>

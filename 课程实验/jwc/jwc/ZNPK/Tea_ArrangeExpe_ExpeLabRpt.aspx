<%@ Page language="c#" Codebehind="Tea_ArrangeExpe_ExpeLabRpt.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.Tea_ArrangeExpe_ExpeLabRpt" %>
<HTML>
	<HEAD>
		<title></title>
		...
		<script language=javascript>
			function trdblclick(Object,sysid,sysrl)
			{
				var xn,xq_id,kcid;
				var BGColor='#89bfa7';
				//双击变色处理
				...
				parent.document.all.sysid.value=sysid;
				parent.document.all.sysrl.value=sysrl;
				parent.ExpeWeekRpt.location.href='Tea_ArrangeExpe_ExpeWeekRpt.aspx?xn='+xn+'&xq_id='+xq_id;
			}
		</script>
	</HEAD>

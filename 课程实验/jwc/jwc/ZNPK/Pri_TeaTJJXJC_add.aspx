<%@ Page language="c#" Codebehind="Pri_TeaTJJXJC_add.aspx.cs" validateRequest="false" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.Pri_TeaTJJXJC_add" %>
<HTML>
	<HEAD>
		<title>录入教学进度表</title>
	...
	<body oncontextmenu="window.event.returnValue=false"
		...
		<form name="form1" action="Pri_TeaTJJXJC_add.aspx" method="post" target="_self">

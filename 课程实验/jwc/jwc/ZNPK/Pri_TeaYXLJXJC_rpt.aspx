<%@ Page language="c#" Codebehind="Pri_TeaYXLJXJC_rpt.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.Pri_TeaYXLJXJC_rpt" %>
<HTML>
	<HEAD>
		<title></title>
		...
		function OpenWindow(vURL,vXNXQ,vSKBJ)
		{
			var theURL;
			winName="winKPT";
			Tform='width=790,height=570,scrollbars=yes,menubar=no,resizable=no,location=no,status=no';
			theURL =vURL+'?xnxq='+vXNXQ+'&skbj='+vSKBJ;

...
<%@ Page language="c#" Codebehind="CKCDDWJXJC.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.CKCDDWJXJC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>承担单位教学进度表</title>
	...
	<body oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		marginheight="0">
		<form name="form1" action="CDDWJXJC_rpt.aspx" target="frmRpt" method="post">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
				<tr>
					<td vAlign="top" align="center" height="26">
						<table WIDTH="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td vAlign="bottom" align="center"><b>承担单位教学进度表</b></td>
							</tr>
							<tr>
					...
					<td height="28">
						<table height="100%" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
							<tr>
								...
								<td align="left" width="34%">承担单位&nbsp;<select name="Sel_CDDW" style="WIDTH:163px"><%=(new Base().SetValue("CDDW","%"))%></select></td>
								<td align="left" width="26%"><br>
								</td>
				...
				<tr>
					<td valign="bottom" align="center" height="100%">
						<iframe name="frmRpt" src="CDDWJXJC_rpt.aspx" width="100%" height="98%" frameborder="0">
						</iframe>
					</td>
				</tr>
			</table>

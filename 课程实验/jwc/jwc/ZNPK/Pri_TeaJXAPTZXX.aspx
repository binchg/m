<%@ Page language="c#" Codebehind="Pri_TeaJXAPTZXX.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.Pri_TeaJXAPTZXX" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
			...
			<tr>
				<td>
					<table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
						<form name="form" method="post" action="Pri_TeaJXAPTZXX_rpt.aspx" ID="Form" target="frmRpt">
								<tr>
									...
									<td width="10%" height="28px" align="right"><input name="Submit01" type="submit" value="检索" class="button" ></td>
								</tr>
						</form>
					</table>
				</td>
			...
			<tr>
				<td valign="top" align="center" height="100%">
					...
					<iframe name="frmRpt" src="Pri_TeaJXAPTZXX_rpt.aspx" width="99%" height="98%" frameborder="0"></iframe>
				</td>
			</tr>
		</table>
	</body>

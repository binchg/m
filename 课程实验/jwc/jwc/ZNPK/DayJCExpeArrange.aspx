<%@ Page language="c#" Codebehind="DayJCExpeArrange.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.DayJCExpeArrange" %>
<%@ Import NameSpace="BLL.ZNPK"%>
<HTML>
	<HEAD>
		<title>周/日/节次实验安排表</title>
	...
	<body oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false
	 leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<form name="form1" method="post" action="DayJCExpeArrange_rpt.aspx" target="frmRpt"  onsubmit="return ChkValue()">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td valign="top" align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td valign="bottom" align="center"><b>周/日/节次实验安排表</b></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="100%" height="26">
									<table width="662" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr>
											<td width=220px>学年学期&nbsp;<select  name="Sel_XNXQ" style='WIDTH:165px'><%=(new Base().SetValue("XNXQ-SYAP"))%></select></td>
											...
											<td width="125px" align=right><input name="Submit01" type="submit" value="检索" class="button"></td>
										</tr>
									</table>
								</td>
							</tr>
				...
				<tr>
					<td align="center"><div id="theHead" style="WIDTH:99%" align="center"></div>
					</td>
				</tr>
				<tr>
					<td valign="top" align="center" height="100%">
						<iframe name="frmRpt" src="DayJCExpeArrange_rpt.aspx" width="99%" height="98%" frameborder="0"></iframe>
					</td>
				</tr>
			</table>
		</form>

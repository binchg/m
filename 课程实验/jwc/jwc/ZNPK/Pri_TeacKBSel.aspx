<%@ Page language="c#" Codebehind="Pri_TeacKBSel.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.Pri_TeacKBSel" %>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
			<tr>
				<td valign="top" align="center">
					<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
						<tr>
							<td valign="bottom" align="center"><b>教学安排(总)</b></td>
						</tr>
						<tr>
			...
			<tr>
				<td>
					<table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
						<form name="form" method="post" action="Pri_TeacKBSel_rpt.aspx" ID="Form" target="frmRpt">
								<tr>
			...
			<tr>
				<td valign="top" align="center" height="100%">
					...
					<iframe name="frmRpt" src="Pri_TeacKBSel_rpt.aspx" width="99%" height="98%" frameborder="0"></iframe>
				</td>
			</tr>
		</table>
	</body>

<%@ Page language="c#" Codebehind="All_LessonSel.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.All_LessonSel" %>
<%@ Import NameSpace="BLL.ZNPK"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 
<HTML>
  <HEAD>
		<title>全校课表[按课程]</title>
	...
	<body  oncontextmenu=window.event.returnValue=false ondragstart=window.event.returnValue=false onsource=window.event.returnValue=false
	 leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">	 
		<form name="form1" action="All_LessonSel_Rpt.aspx" target="frmRpt" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align=center>
			<tr>
				<td vAlign="top" align="center" height="26">
					<table WIDTH="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
						<tr>
							<td vAlign="bottom" align="center"><b>全校课表[按课程]</b></td>
						</tr>
						<tr>
				...
				<td height="28px">
					<table height="100%" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
						<tr>
							...
							<td align="left" width="34%" >承担单位&nbsp;<select name="Sel_CDDW" style="width:163px"><%=(new Base().SetValue("CDDW",USER_OPTDW))%></select></td>
			...
			<tr>
				<td valign="bottom" align="center" height="100%">
					<iframe name="frmRpt" src="All_LessonSel_Rpt.aspx" width="100%" height="98%" frameborder="0">
					</iframe>
				</td>
			</tr>
		</table>

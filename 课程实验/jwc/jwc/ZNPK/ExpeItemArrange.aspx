<%@ Page language="c#" Codebehind="ExpeItemArrange.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.ExpeItemArrange" %>
...
<HTML>
	<HEAD>
		...
		<script language="javascript">
			function ChkValue()
			{
				var vEXPEITEM;
				try{
					vEXPEITEM=document.all.Sel_EXPEITEM.value;
					if((vEXPEITEM=="")||(vEXPEITEM=="Nothing")){
						alert('需选定实验项目！');
						return false;
					}else{
						form.method='post';
						form.action='ExpeItemArrange_rpt.aspx';
						form.target='frmRpt';
						form.submit();
						return true;
					}
			...
			function ShowListValue(theID,vP)
			{
				...
				try{
					...
					if(vXNXQ!="")
					{
						theURL="./Private/List_"+vP+".aspx?xnxq="+vXNXQ+"&expeitem="+theID.value;
	...
	<body oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		marginheight="0">
		<form name="form" method="post" action="ExpeItemArrange_rpt.aspx" onsubmit="return ChkValue()">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td valign="top" align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td valign="bottom" align="center"><b>实验项目安排表</b></td>
							</tr>
							<tr>
					...
					<td height="28">
						<table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td width="52%"><%=(new Base().SetValue("XNXQEXPEITEM"))%></td>
				...
				<tr>
					<td valign="top" align="center" height="100%">
						...
						</iframe><iframe name="frmRpt" src="ExpeItemArrange_rpt.aspx" width="99%" height="99%" frameborder="0">
						</iframe>
					</td>
				</tr>
			</table>

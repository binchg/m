<%@ Page language="c#" Codebehind="All_ExpeItemExpeArrange.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.All_ExpeItemExpeArrange" %>
<%@ Import NameSpace="BLL.ZNPK"%>
<HTML>
	<HEAD>
		<title>全校实验安排表[按实验项目]</title>
		...
		<script language="javascript">
			function ChkValue()
			{
				try{
					form.method='post';
					form.action='All_ExpeItemExpeArrange_rpt.aspx';
					form.target='frmRpt';
					form.submit();
					return true;
				}catch(e){}
	...
	<body oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		marginheight="0">
		<form name="form" method="post" action="All_ExpeItemExpeArrange_rpt.aspx" onsubmit="return ChkValue()">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td valign="top" align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td valign="bottom" align="center"><b>全校实验安排表[按实验项目]</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td valign="top" align="center" height="100%">
						...
						</iframe><iframe name="frmRpt" src="All_ExpeItemExpeArrange_rpt.aspx" width="99%" height="99%" frameborder="0">
						</iframe>
					</td>
				</tr>
			</table>

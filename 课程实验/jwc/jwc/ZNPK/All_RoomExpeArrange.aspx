<%@ Page language="c#" Codebehind="All_RoomExpeArrange.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.All_RoomExpeArrange" %>
<%@ Import NameSpace="BLL.ZNPK"%>
<HTML>
	<HEAD>
		<title>全校实验安排表[按实验(分)室]</title>
			...
			function ChkValue()
			{
				...
				try{
					...
					if((vYX=="")||(vYX=="Nothing")){
						...
						form.method='post';
						form.action='All_RoomExpeArrange_rpt.aspx';
						form.target='frmRpt';
						form.submit();
						return true;
					}
	...
	<body oncontextmenu="window.event.returnValue=false" ondragstart="window.event.returnValue=false"
		...
		marginheight="0">
		<form name="form" method="post" action="All_RoomExpeArrange_rpt.aspx" onsubmit="return ChkValue()">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				<tr>
					<td valign="top" align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
							<tr>
								<td valign="bottom" align="center"><b>全校实验安排表[按实验(分)室]</b></td>
							</tr>
							<tr>
				...
				<tr>
					<td valign="top" align="center" height="100%">
						...
						</iframe><iframe name="frmRpt" src="All_RoomExpeArrange_rpt.aspx" width="99%" height="99%" frameborder="0">
						</iframe>
					</td>
				</tr>
			</table>

<%@ Page language="c#" Codebehind="KBFBAll_ClassSel.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.KBFBAll_ClassSel" %>
				...
				<td height="56px">
					<table height="100%" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
						...
						<tr>
							...
							<td width="60%"  align="left"  height="28px"><%=(new Base().SetValue("YXZY","%"))%></td>

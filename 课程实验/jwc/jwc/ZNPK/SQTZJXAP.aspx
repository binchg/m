				...
				<td height="28px">
					<table height="100%" cellSpacing="0" cellPadding="0" width="660" align="center" border="0">
						<tr>
							...
							<td align="left" width="34%" >承担单位&nbsp;<select id="Sel_CDDW" name="Sel_CDDW" style="width:163px"><%=(new Base().SetValue("CDDW",USER_OPTDW))%></select></td>
							<td align="left" width="26%" ><br></td> 
							<td align="right" width="6%" nowrap>
							<input name="Submit01" type="submit" value="检索" class="button"></td>
						</tr>
					</table>
				</td>
			</tr>

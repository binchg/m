...
<%@ Page language="c#" Codebehind="ClassSel.aspx.cs" AutoEventWireup="false" Inherits="JWNET.ZNPK.ClassSel" %>
...
<HTML>
	...
	leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		<form name="form" method="post" action="ClassSel_rpt.aspx" onsubmit="return ChkValue()">
			...
			<tr>
				<td valign="top" align="center" height="100%">
					...
					<iframe name="frmRpt" src="ClassSel_rpt.aspx" width="99%" height="98%" frameborder="0"></iframe>
				</td>
			</tr>
			</table>
			</form>

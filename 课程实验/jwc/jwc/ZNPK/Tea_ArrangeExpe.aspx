<%@ Page language="c#" Codebehind="Tea_ArrangeExpe.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.Tea_ArrangeExpe" %>
		...
		function SaveChkValue(){
			...
			if(timestr==""){
				...
				if(confirm("是否保存？")){
					...
					form1.action='Tea_ArrangeExpe_Datarpt.aspx?flag=save';
					form1.submit();
					return true;
				}
			}
		...
		function DelChkValue()
		{
			...
			if(deldata!=""){
				if(confirm("是否取消？")){
					...
					form1.target='hiddenFrm';
					form1.action='Tea_ArrangeExpe_Datarpt.aspx?flag=del';
					form1.submit();
				}
			}
		}
	...
	<table width="660px" border="0" cellspacing="0" cellpadding="0" height="100%" align=center >
		...
		<tr><td valign="top" align="center">
			<table width="100%" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
				<tr><td valign="bottom" align="center"><b>安排实验</b></td></tr>
			...
			<table width=100% height="100%" border=0 cellpadding=0 cellspacing=0>
				...
				<tr>
					<td width=55% height=100% align=left >
						<iframe name=frmLRpt src="Tea_ArrangeExpe_Lrpt.aspx?xn=<%=xn%>&xq=<%=xq%>&js=<%=js%>" width=100% height=99% frameborder=1></iframe>
					</td>
					<td height=100% style="width:3px">&nbsp;</td>
					<td width=45% height=100% align=left >
						<iframe name=frmRRpt src="Tea_ArrangeExpe_Rrpt.aspx" width=100% height=99% frameborder=1></iframe>
					</td>
				</tr>
			</table> 
		</td></tr>
		...
		<tr><td valign="top" align="left" height="45%">
			...
			<iframe name=frmRpt src="Tea_ArrangeExpe_rpt.aspx?xn=<%=xn%>&xq=<%=xq%>&js=<%=js%>" width=100% height=99% frameborder=1></iframe>

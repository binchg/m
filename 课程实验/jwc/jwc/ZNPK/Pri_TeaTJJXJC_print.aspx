<%@ Page language="c#" Codebehind="Pri_TeaTJJXJC_print.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.ZNPK.Pri_TeaTJJXJC_print" %>
<HTML>
	<HEAD>
		<title>打印教学进度表</title>
		...
		<style>v\\:* {BEHAVIOR:url(#default#VML)}
			@media print{div.buttonarea {display:none}}</style> 
	</HEAD>

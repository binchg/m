...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>统计等级考试报名情况(二)</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form" method="post" action="e_wsbmqk_rpt.aspx" target="main" >              
  <tr><td valign="top" align="center" height="5%">
	<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
	  <tr> 
		<td height="26" colspan="2" align="" nowrap>
		<%=SelObj.SetValue("njyxzybj",USER_OPTYX)%>              
		</td>           
	  <tr> 
		<td width="87%" align="" height="13"> 
			...
			</td><td width=6% align='right' height="26"><input type="submit" name="btn_search" value="检索" class=button></td>
	  </tr>
	</table>  
</td></tr>
</form>
...
<iframe name=main src="e_wsbmqk_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>

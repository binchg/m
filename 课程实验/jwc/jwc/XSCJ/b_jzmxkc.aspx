...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>禁止免修课程/环节</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="b_jzmxkc_rpt.aspx" target="main">              
      <tr><td valign="top" align="center" height="5%" width="100%">
        <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
          <tr>
          <td><%=SelObj.SetValue("njyxzy",USER_OPTYX)%></td> 
		   <td align=right><input type="submit" name="btn_search" value="检索" class=button></td>   
         </tr>
	 <tr>
	   <td colspan=3>学年学期 <select name=sel_xnxq style='width:165'><%=SelObj.SetValue("xnxq","")%></select></td>
	 </tr>
        </table>
</td></tr>
</form>
...
<iframe name=main src="b_jzmxkc_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr>

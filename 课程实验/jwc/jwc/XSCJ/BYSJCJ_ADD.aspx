...
<form name="form1" method="post" action="BYSJCJ_ADD_rpt.aspx">
 <tr><td>
  <table width="660" border=0 align="center" cellpadding="0" cellspacing="0"  >
	...
	<%   
		 ...
		 Response.Output.Write((new BLL.XSCJ.BLL_subPrivate_XSCJ()).SetValue("CJLRBYSJNJZYKC",vXNXQ,USER_ID));
		 Response.Output.Write ("</td><td height=25  id=bynjzyfx colspan=4 style='display:none'>");
		 Response.Output.Write((new BLL.XSCJ.BLL_subPrivate_XSCJ()).SetValue("CJLRBYSJNJZYKCFX",vXNXQ,USER_ID));
...
<iframe name=frmRpt src="BYSJCJ_ADD_rpt.aspx" width=100% height=98% frameborder=1></iframe>
</td></tr>

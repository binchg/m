...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>分行政班级按学年/学期查看成绩[有效]</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="f_bjxqcj_rpt.aspx" target="main" onSubmit="return ChkValue(this)">              
<tr><td valign="top" align="center" height="5%" width="100%">
	<table width=660 border=0 cellspacing=0 cellpadding=0 align=center height=26>
	<tr>
	  <td colspan=2 align=center><%=SelObj.SetValue("njyxzybj",USER_OPTYX)%></td>
	</tr>
...
<iframe name=main src="f_bjxqcj_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr>

...
<%
	...
	if(Request.ServerVariables["REQUEST_METHOD"] == "POST")
	{
		...
		try{vRpt=Request.Form["radSwap"].ToString().Trim();}catch(Exception){vRpt="";}
		try{R=pSub.GetRowsCXMX(vXNXQ,vYX,vZY,vBJ,vCDDW,vKC,vRpt);
		}catch(Exception ){}
	}
	pSub.ArrayDefineCXMX(vRpt);
	if (R>0)
	{
		try{Response.Output.Write (pSub.DrawRptMainCXMX(vXNXQ,vRpt,vYX,vZY,vBJ,vCDDW,vKC));
		}catch(Exception ){}
	} 
%>
</center>

...
if (P=="1")
{
	vTitleStr="分行政班级按课程打印成绩登记册①";
}
else if (P=="2")
{
    vTitleStr="分课程按行政班级打印成绩登记册⑤";
}
...
<form name="form" method="post" action="CJJZD_XZBJKC_rpt.aspx" target="main" >              
  <tr><td valign="top" align="center" height="5%">
	<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
	  <tr> 
		...
		<%  if (P=="1")
		    { 
				Response.Output.Write((new BLL.XSCJ.BLL_subPrivate_XSCJ()).SetValue("CJDJCXNXQBJKC",USER_ID));
			}
		    else if (P=="2")
		    {
	       	    Response.Output.Write((new BLL.XSCJ.BLL_subPrivate_XSCJ()).SetValue("CJDJCXNXQKCBJ",USER_ID));
	       	}
		%>
		</td>
	  <tr> 
...
<iframe name=main src="CJJZD_XZBJKC_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>

...
<form name="form" method="post" action="CJJZD_XZBJHJ_rpt.aspx" target="main" >              
  <tr><td valign="top" align="center" height="5%">
	<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
	  <tr> 
		<td height="26" align="" nowrap><%Response.Output.Write((new BLL.XSCJ.BLL_subPrivate_XSCJ()).SetValue("CJDJCXNXQBJHJ",USER_ID));%> </td>           
...
<iframe name=main src="CJJZD_XZBJHJ_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>

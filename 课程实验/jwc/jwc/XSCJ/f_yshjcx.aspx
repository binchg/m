...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>分承担单位按环节查看重修成绩④[原始]</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form" method="post" action="f_yshjcx_rpt.aspx" target="main">              
  <tr><td valign="top" align="center" height="5%">
	<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
	  <tr>
	  <td><%=SelObj.SetValue("XNXQHJCXYS",USER_OPTDW)%></td>
	  </tr>
	  <tr><td align=right valign=top><input type=submit name=btn_seach  value='检索' class=but20></td></tr>
	</table>  
</td></tr>
</form>
...
<iframe name=main src="f_yshjcx_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>

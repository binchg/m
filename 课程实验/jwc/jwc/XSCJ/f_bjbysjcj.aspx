	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" >
		<tr><td valign="top" align="center">
			<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
				<tr><td valign="bottom" align="center"><b>分毕业年届按班级打印毕业设计(论文)成绩⑧[原始]</b></td></tr>
				<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script></td></tr>
			</table>   
		</td></tr>
		<form name="form" method="post" action="f_bjbysjcj_rpt.aspx" target="main">              
			<tr><td valign="top" align="center" height="5%">
				<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
				<tr>
				<td><%=SelObj.SetValue("XNXQBJBYSJCJ",USER_OPTYX)%></td>
		...
		<tr><td valign="top" align="center" height="100%">
			<iframe name=main src=f_bjbysjcj_rpt.aspx width=99% height=98% frameborder=0></iframe>
		</td></tr> 
	</table>
	</body>
</html>

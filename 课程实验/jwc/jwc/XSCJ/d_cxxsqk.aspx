...
<tr><td valign="top" align="center">
      <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
        <tr><td valign="bottom" align="center"><b>统计学生重修情况</b></td></tr>
	<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
	</td></tr>
      </table>   
</td></tr>
<form name="form1" method="post" action="d_cxxsqk_rpt.aspx" target="main" >
      <tr><td valign="top" align="center" height="5%">
        <table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
	     ...
	     <select name=sel_xnxq><%Response.Output.Write((new BLL.XSCJ.BLL_subPrivate_XSCJ()).SetValue("XNXQ","","") );%></select>
  	     ...
  	     <input type=radio name=radCx id=radCx2 onclick='chkCx()' value="2" checked>分承担单位 
	     <input type=radio name=radCx id=radCx1 onclick='chkCx()' value="1">分院(系)/部
	     </td>
...
<iframe name=main src="d_cxxsqk_rpt.aspx" width=99% height=98% frameborder=0></iframe>
</td></tr> 
</table>
</body>
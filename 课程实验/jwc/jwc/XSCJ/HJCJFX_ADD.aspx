...
SelObj.DoorOnOff(this,"CJ_HJ_FX-RRL");
...
<form name="form1" method="post" action="HJCJFX_ADD_rpt.aspx">
 <tr><td>
  <table width="660" border=0 align="center" cellpadding="0" cellspacing="0"  >
    <tr><td colspan=4>
      <table border=0 align="left" cellpadding="0" cellspacing="0">
	<%  Response.Output.Write (" <td height=25  id=bjkc colspan=4 >");
		Response.Output.Write((new BLL.XSCJ.BLL_subPrivate_XSCJ()).SetValue("CJLRYXZYHJFX",vXNXQ,USER_ID));
...
<iframe name=frmRpt src="HJCJFX_ADD_rpt.aspx" width=100% height=98% frameborder=1></iframe>
</td></tr> 
</table>

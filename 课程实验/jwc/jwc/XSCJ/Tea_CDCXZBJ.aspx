<%@ Page language="c#" Codebehind="Tea_CDCXZBJ.aspx.cs" AutoEventWireup="false" Inherits="KingosoftFrame.XSCJ.Tea_CDCXZBJ" %>

<html>
  <head>
    <title>分课程按行政班级打印成绩登记册</title>
		...
		<table width="99%" align=center border="0" cellspacing="0" cellpadding="0" height="100%" >
			<tr><td valign="top" align="center">
				<table width="660" border=0 cellspacing="0" cellpadding="0" align="center" height="26">
					<tr><td valign="bottom" align="center"><b>分课程按行政班级打印成绩登记册</b></td></tr>
				<tr><td valign="bottom" align="center"><script language="JavaScript" >Draw_HR('99.5%')</script>
				</td></tr>
				</table>   
			</td></tr>
			<form name=form1 action=Tea_CDCXZBJ_rpt.aspx method=post target=frmRpt>
			...
			<tr><td valign="top" align="center" height="100%" width="100%">
				<iframe name=frmRpt src="Tea_CDCXZBJ_rpt.aspx" width=100% height=98% frameborder=0></iframe>
			</td></tr>
		</table>
	</body>
</html>
